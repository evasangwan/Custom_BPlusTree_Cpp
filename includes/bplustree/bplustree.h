...
#include <cassert>
#include <vector> 
#include "../btree_array_funcs/btree_array_funcs.h"
using namespace std;
    ...
    void loose_remove(const T& entry){
            ...
            if (found){
                if (is_leaf()){
                    ...
                    // for (int a = 0; a < subset[i+1]->data_count; a++){
                    //     if (subset[i+1]->data[a] == entry){
                    //         subset[i+1]->get_smallest(subset[i+1]->data[a]);
                    //         break;
                    //     }
                    // }
                }
                ...
                if (subset[i]->data_count < MINIMUM){
                    ...
                    // if (subset[i]){
                        ...
                        // if (i <= child_count-1){
                        //     cout << "ever comes in here"<<endl;
                        //     for (int a = 0; a < subset[i]->data_count; a++){
                        //         if (subset[i]->data[a] == entry){
                        //             bool f = false;
                        //             assert(f);
                        //             cout << "fine but is it ever here"<<endl;
                        //             subset[i+1]->get_smallest(subset[i]->data[a]);
                        //             //subset[i]->subset[i]->get_smallest(subset[i]->data[a]);
                        //             break;
                        //         }
                        //     }
                        // }
                    ...
                    // if (subset[i+1]){
                        // for (int a = 0; a < subset[i+1]->data_count; a++){
                        //     if (subset[i+1]->data[a] == entry){
                        //         subset[i+1]->subset[i+1]->get_smallest(subset[i+1]->data[a]);
                        //         break;
                        //     }
                        // }
                        // }
